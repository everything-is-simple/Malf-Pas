...
| `MALF v1.5` | planned successor structure fact layer | 计划新增 `wave_behavior_snapshot`，仍由 MALF 拥有结构行为事实 |
...
| MALF v1.5 / PAS v1.2 design revision | `authorized as roadmap-governed docs only` |
